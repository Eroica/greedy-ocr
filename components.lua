...
function Word.new(image, bounding_box)
    ...
    word.image = image:sub(top_left[1], bottom_right[1], top_left[2], bottom_right[2])
    word.bounding_box = bounding_box

    -- table.insert(word, Component.new(word, 0, word.image:size()[1]))
